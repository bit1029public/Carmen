...
def get_ddi_matrix(records, med_voc, ddi_file):
    ...
    dill.dump(ehr_adj_num, open('ehr_adj_num_final.pkl', 'wb'))  
...
if __name__ == '__main__':
    ...
    datadir = os.path.dirname(os.path.abspath(__file__)) + '/MIMIC-III/'
    med_file = datadir + "PRESCRIPTION.csv"  # '/srv/local/data/physionet.org/files/mimiciii/1.4/PRESCRIPTIONS.csv'
